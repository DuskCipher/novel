...
export default function MobileNav() {
  ...
  if (mode === 'donghua') {
    ...
    links = [
      { href: '/anime', icon: Home, label: 'Home' },
      { href: '/anime/schedule', icon: Calendar, label: 'Jadwal' },
      { href: '/anime/genre/movie', icon: Film, label: 'Movie' },
      { href: '/anime/genres', icon: LayoutGrid, label: 'Genre' },
      { href: '/anime/search', icon: Compass, label: 'Explore' },
      { href: '/', icon: Globe, label: 'Main Site' },
    ];
  } else {
    // Main Site
