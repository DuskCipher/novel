...
export default function MainLayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <Navbar />
      <main className="flex-1 w-full pt-24 sm:pt-28 pb-12 flex flex-col relative min-h-[85vh] max-w-[1600px] mx-auto px-4 md:px-8 overflow-x-hidden">
        <div className="flex flex-col lg:flex-row w-full gap-8 lg:gap-10 mt-4 sm:mt-6">
          {children}
        </div>
      </main>
      <footer className="bg-zinc-100 dark:bg-[#1f1f22] border-t border-zinc-200 dark:border-zinc-800 mt-auto pb-20 md:pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col items-center">
          ...
          <div className="flex items-center gap-4 mb-6">
            <a href="#" className="w-10 h-10 rounded-full bg-[#25D366] flex items-center justify-center text-white hover:opacity-80 transition-opacity">
            ...
            <a href="#" className="w-10 h-10 rounded-full bg-[#5865F2] flex items-center justify-center text-white hover:opacity-80 transition-opacity">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
            ...
            <a href="#" className="w-10 h-10 rounded-full bg-[#1877F2] flex items-center justify-center text-white hover:opacity-80 transition-opacity">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
              </svg>
            </a>
            <a href="#" className="w-10 h-10 rounded-full bg-black flex items-center justify-center text-white hover:opacity-80 transition-opacity">
